...
export default function CreateInvitePage() {
  ...
  return (
    <div className="p-6 max-w-xl">
      ...
      <button onClick={createInvite} className="mt-4 px-4 py-2 rounded bg-black text-white">
        Tạo link
      </button>
      ...
      {link && (
        <div className="mt-4">
          ...
          <input className="w-full border p-2 rounded mt-2" value={link} readOnly />
          <button className="mt-2 px-3 py-2 rounded border" onClick={() => copyToClipboard(link)}>
            Copy
          </button>
        </div>
      )}
